...
public class BarangPenggunaanPadaDiri extends Barang {
    ...
    BarangPenggunaanPadaDiri(int idBarang, String nama, String deskripsi, boolean statusJual, boolean statusBeli, int hargaJual, int hargaBeli, int kesehatan) {
    ...
    private BarangPenggunaanPadaDiri prosesCloning(BarangPenggunaanPadaDiri oBarang){
        BarangPenggunaanPadaDiri barangCloning = new BarangPenggunaanPadaDiri(oBarang.idBarang, oBarang.nama, oBarang.deskripsi, oBarang.statusJual, oBarang.statusBeli, oBarang.getHargaJual(), oBarang.getHargaBeli(), oBarang.kesehatan);
